...
a|icon:lock[title=Fixed at build time] [[quarkus-antivirus_quarkus-antivirus-clamav-devservice-testcontainers-startup-timeout]]`link:#quarkus-antivirus_quarkus-antivirus-clamav-devservice-testcontainers-startup-timeout[quarkus.antivirus.clamav.devservice.testcontainers-startup-timeout]`
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_ANTIVIRUS_CLAMAV_DEVSERVICE_TESTCONTAINERS_STARTUP_TIMEOUT+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_ANTIVIRUS_CLAMAV_DEVSERVICE_TESTCONTAINERS_STARTUP_TIMEOUT+++`
endif::add-copy-button-to-env-var[]
--|int 
|`120`
