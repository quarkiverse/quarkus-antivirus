...
* https://www.icap-project.org/[ICAP] The Internet Content Adaptation Protocol (ICAP) is widely used to enhance network security by enabling communication between clients and servers for tasks such as antivirus scanning and data loss prevention. Several products support ICAP scanning, either as ICAP servers providing scanning services or as clients integrating ICAP capabilities. Examples include:
** https://www.opswat.com/products/meta-defender[MetaDefender ICAP Server] by OPSWAT
** https://www.clearswift.com/products/clearswift-secure-icap-gateway[Clearswift Secure ICAP Gateway] by Clearswift
** https://www.clamav.net/documents/clamav-icap-server[ClamAV ICAP Server] by ClamAV
** https://www.open-scap.org/tools/icap-server/[OpenSCAP ICAP Server] by OpenSCAP
** https://www.cloudmersive.com/antivirus-api[Cloudmersive ICAP Anti-Virus Scanning Server] by Cloudmersive
** https://www.broadcom.com/products/cyber-security/antivirus-and-antimalware/icap-server[Broadcom ICAP Server] by Broadcom
** https://www.f-prot.com/products/f-prot-icap-server[F-Prot ICAP Server] by F-Prot
** https://www.f-secure.com/en/business/products/f-secure-icap-server[F-Secure ICAP Server] by F-Secure
** https://www.fortinet.com/products/forticlient-endpoint-protection-and-management/icap-server[Fortinet ICAP Server] by Fortinet
** https://www.gfi.com/products/gfi-icap-server[GFI ICAP Server] by GFI
** https://www.kaspersky.com/business-security/icap-server[Kaspersky ICAP Server] by Kaspersky
** https://www.sophos.com/en-us/products/sophos-icap-server[Sophos ICAP Server] by Sophos
