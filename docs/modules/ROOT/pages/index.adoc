...
=== ClamAV
https://www.clamav.net/[ClamAV] is an open source Linux based virus scanning engine. If you configure `quarkus.antivirus.clamav.devservice.enabled=true` a DevService will start a ClamAV instance for you on TCP port 3310, so you can test locally during development.

[source,properties]
----
quarkus.antivirus.clamav.enabled=true
quarkus.antivirus.clamav.health.enabled=true
%dev.quarkus.antivirus.clamav.devservice.enabled=true
%dev.quarkus.antivirus.clamav.host=localhost
%dev.quarkus.antivirus.clamav.port=3310
----
